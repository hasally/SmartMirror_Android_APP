...
public class CustomLogoutTask extends AsyncTask<String, Void, String>{
    ...
    public CustomLogoutTask(Context context) {
        mContext = context;
    ...
    protected String doInBackground(String... strings) {
        ...
        try {
            URL url = new URL(ip_name+"logout.do");//보낼 jsp 주소를 ""안에 작성합니다.
