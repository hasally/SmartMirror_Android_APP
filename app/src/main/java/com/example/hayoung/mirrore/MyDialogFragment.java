...
public class MyDialogFragment extends DialogFragment {
    ...
    Mirror_SettingFragment mirror_settingFragment;
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        mirror_settingFragment = new Mirror_SettingFragment();
        ...
        switch (id) {
            case DEVICES_DIALOG:
                ...
                Set<BluetoothDevice> pairedDevices = mirror_settingFragment.getPairedDevices();
                ...
                alertDialogBuilder.setItems(items, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        dialog.dismiss();
                        mirror_settingFragment.doConnect(devices[which]);
                    }
                });
