...
public class CustomMotionTask extends AsyncTask<String, Void, String> {
    ...
    public CustomMotionTask(Context context) {
        mContext = context;
    ...
    protected String doInBackground(String... strings) {
        try {
            URL url = new URL(ip_name+"alarmWeb.do");//보낼 jsp 주소를 ""안에 작성합니다.
