...
public class DeleteMemo extends AsyncTask<String, Void, String> {
    ...
    public DeleteMemo(Context context) {
        mContext = context;
    ...
    protected String doInBackground(String... strings) {
        ...
        try {
            ...
            URL url = new URL(ip_name+"memoDelete.do");
            ...
            jobj.put("identifier", strings[0]);
            jobj.put("mirror_id", userInfo.getKeyMirrorId());

            System.out.println("identifier: "+strings[0]);
