...
public class CustomSettingTask extends AsyncTask<String, Void, String> {
    ...
    public CustomSettingTask(Context context) {
        mContext = context;
    ...
    protected String doInBackground(String... strings) {
        ...
        try {
            //192.168.0.15
            URL url = new URL(ip_name+"update_setting.do");//보낼 jsp 주소를 ""안에 작성합니다.
            ...
            jobj = new JSONObject();
            jobj.put("setting_key", strings[0]);
            jobj.put("setting_value", strings[1]);
            jobj.put("setting_id", strings[2]);
            jobj.put("mirror_id", userInfo.getKeyMirrorId());

            System.out.println("update_setting:"+strings[0]+":"+strings[1]+":"+ strings[2]);

            /*String requestStr = "setting_key=" + strings[0] + "&setting_value=" + strings[1] +"&setting_id=" +strings[2];
            System.out.println("setting_key=" + strings[0] + "&setting_value=" + strings[1] +"&setting_id=" +strings[2]);
*/
